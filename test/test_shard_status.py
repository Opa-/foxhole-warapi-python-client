...
class TestShardStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShardStatus:
        """Test ShardStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShardStatus`
        """
        model = ShardStatus()
        if include_optional:
            return ShardStatus(
                b_show_colonial_queue_warning = True,
                ...
                squad_max_size = 40,
                seconds_to_pre_conquest = 0,
                b_is_pre_conquest = False,
                b_is_vip_mode = False
            )
        else:
            return ShardStatus(
