...
from warapi_client.models.server_connection_info import ServerConnectionInfo  # noqa: E501
...
class TestServerConnectionInfo(unittest.TestCase):
    ...
    def testServerConnectionInfo(self):
        ...
        # model = warapi_client.models.server_connection_info.ServerConnectionInfo()  # noqa: E501
        pass
