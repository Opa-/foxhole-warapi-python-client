...
class MapItem(BaseModel):
    ...
    MapItem
    """ # noqa: E501
    team_id: Optional[FactionEnum] = Field(default=None, alias="teamId")
    icon_type: Optional[StrictInt] = Field(default=None, alias="iconType")
    x: Optional[Union[StrictFloat, StrictInt]] = None
    y: Optional[Union[StrictFloat, StrictInt]] = None
    flags: Optional[StrictInt] = None
    view_direction: Optional[StrictInt] = Field(default=None, alias="viewDirection")
    __properties: ClassVar[List[str]] = ["teamId", "iconType", "x", "y", "flags", "viewDirection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "y": obj.get("y"),
            "flags": obj.get("flags"),
            "viewDirection": obj.get("viewDirection")
        })
        return _obj
