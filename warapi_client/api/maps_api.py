...
from warapi_client.api_client import ApiClient, RequestSerialized
from warapi_client.api_response import ApiResponse
from warapi_client.rest import RESTResponseType
...
class MapsApi:
    ...
    def get_map_dynamic(
        self,
        map_name: Annotated[StrictStr, Field(description="Name of the map")],
        if_none_match: Annotated[Optional[StrictStr], Field(description="https://datatracker.ietf.org/doc/html/rfc7232")] = None,
        ...
        :param map_name: Name of the map (required)
        :type map_name: str
        :param if_none_match: https://datatracker.ietf.org/doc/html/rfc7232
        ...
        _param = self._get_map_dynamic_serialize(
            map_name=map_name,
    ...
    @validate_call
    def get_map_dynamic_with_http_info(
        self,
        map_name: Annotated[StrictStr, Field(description="Name of the map")],
        if_none_match: Annotated[Optional[StrictStr], Field(description="https://datatracker.ietf.org/doc/html/rfc7232")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_map_dynamic_without_preload_content(
        self,
        map_name: Annotated[StrictStr, Field(description="Name of the map")],
        if_none_match: Annotated[Optional[StrictStr], Field(description="https://datatracker.ietf.org/doc/html/rfc7232")] = None,
        _request_timeout: Union[
    ...
    def _get_map_dynamic_serialize(
        self,
        map_name,
        if_none_match,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/worldconquest/maps/{mapName}/dynamic/public',
    ...
    def get_map_static(
        ...
        _param = self._get_map_static_serialize(
            map_name=map_name,
            if_none_match=if_none_match,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_map_static_with_http_info(
        self,
        map_name: Annotated[StrictStr, Field(description="Name of the map")],
        if_none_match: Annotated[Optional[StrictStr], Field(description="https://datatracker.ietf.org/doc/html/rfc7232")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_map_static_without_preload_content(
        self,
        map_name: Annotated[StrictStr, Field(description="Name of the map")],
        if_none_match: Annotated[Optional[StrictStr], Field(description="https://datatracker.ietf.org/doc/html/rfc7232")] = None,
        _request_timeout: Union[
    ...
    def _get_map_static_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/worldconquest/maps/{mapName}/static',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_maps_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/worldconquest/maps',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_war_report(
        ...
        _param = self._get_war_report_serialize(
            map_name=map_name,
            if_none_match=if_none_match,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_war_report_with_http_info(
        self,
        map_name: Annotated[StrictStr, Field(description="Name of the map")],
        if_none_match: Annotated[Optional[StrictStr], Field(description="https://datatracker.ietf.org/doc/html/rfc7232")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_war_report_without_preload_content(
        self,
        map_name: Annotated[StrictStr, Field(description="Name of the map")],
        if_none_match: Annotated[Optional[StrictStr], Field(description="https://datatracker.ietf.org/doc/html/rfc7232")] = None,
        _request_timeout: Union[
    ...
    def _get_war_report_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/worldconquest/warReport/{mapName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
